...
class Storage {
    ...
    static var defaultAlert: [String: Any] {
        get {
            return UserDefaults.standard.dictionary(forKey: "defaultAlert") ?? ["notification": true, "alert_for_dta": true, "dta_alert_thresh": 3, "alert_for_bsa": true, "bsa_alert_thresh": 10, "alert_for_tvv": true, "tvv_alert_thresh": 3, "alert_for_rr": true, "rr_alert_thresh": 3, "rr_alert_lower_thresh": 0, "rr_alert_duration": 10, "alert_for_tvi": true, "tvi_alert_thresh": 600, "tvi_alert_lower_thresh": 100, "tvi_alert_duration": 5, "alert_for_mv": true, "mv_alert_thresh": 40, "mv_alert_lower_thresh": 5, "mv_alert_duration": 5, "alert_for_maw": true, "maw_alert_thresh": 40, "maw_alert_lower_thresh": 5, "maw_alert_duration": 5, "minutes_between_alerts": 30]
        }
        set(defaultAlert) {
