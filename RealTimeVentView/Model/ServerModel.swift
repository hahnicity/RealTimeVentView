...
// Luigi
let BREATH_ASYNCHRONY = ["BSA", "DTA", "TVV"]
...
let BREATH_METADATA = ["E-Time", "I-Time", "I:E Ratio", "TVe", "TVi", "TVe/TVi", "epAUC", "ipAUC", "RR", "PEEP", "PIP", "MAW"]
let BREATH_STAT_METADATA = ["E-Time", "I-Time", "I:E Ratio", "TVe", "TVi", "TVe/TVi", "epAUC", "ipAUC", "RR", "MV", "PEEP", "PIP", "MAW"]
let METADATA_TO_PACKET_NAME = ["E-Time": PACKET_E_TIME, "I-Time": PACKET_I_TIME, "I:E Ratio": PACKET_IE_RATIO, "TVe": PACKET_TVE, "TVi": PACKET_TVI, "TVe/TVi": PACKET_TVE_TVI_RATIO, "epAUC": PACKET_EP_AUC, "ipAUC": PACKET_IP_AUC, "RR": PACKET_RR, "PEEP": PACKET_PEEP, "PIP": PACKET_PIP, "NumBreaths": PACKET_NUM_BREATHS, "MV": PACKET_MV, "MAW": PACKET_MAW]
let PACKET_NAME_TO_METADATA = [PACKET_E_TIME: "E-Time", PACKET_I_TIME: "I-Time", PACKET_IE_RATIO: "I:E Ratio", PACKET_TVE: "TVe", PACKET_TVI: "TVi", PACKET_TVE_TVI_RATIO: "TVe/TVi", PACKET_EP_AUC: "epAUC", PACKET_IP_AUC: "ipAUC", PACKET_RR: "RR", PACKET_PEEP: "PEEP", PACKET_PIP: "PIP", PACKET_NUM_BREATHS: "NumBreaths", PACKET_MV: "MV", PACKET_MAW: "MAW"]
